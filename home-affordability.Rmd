...
income <- tribble(
  ...
  "person 1", "job 1",    100000,
  "person 2", "job 2",    100000,
  "person 2", "job 3",     20000,
)
...
result <- tribble(
  ...
  "cash to close", dollar(max_affordable[["p_h"]] * (1 + buying_costs_rate) - max_affordable[["p_l"]])
)
knitr::kable(result)
```
...
houses <- tribble(
  ...
  "100 Main St", 675000, 200, 00000,
  "100 Main St", 675000, 200, 20000,
  "100 Main St", 675000, 200, 40000,
  "100 Main St", 675000, 200, 60000,
  "200 Main St", 725000, 0, 00000,
  "200 Main St", 725000, 0, 20000,
  "200 Main St", 725000, 0, 40000,
  "200 Main St", 725000, 0, 60000,
)
```
