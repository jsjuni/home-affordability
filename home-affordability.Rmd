...
savings <- tribble(
  ~asset,    ~balance,
  "CEFCU Share", 344053.53,
  "Escrow", 25035,
  "Wells Fargo", 9203.13,
  "United Visa", -24604.55,
  # "savings", 100000,
)
...
Under the guidelines, our maximum monthly payment is
`r dollar(max_pt)`, the most expensive house we can afford is `r dollar(max_affordable[["p_h"]])`,
...
houses <- tribble(
  ...
  "30 Beekman St #105", 505035, 301.25, 40000 - 3974,
